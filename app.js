...
function sortearAmigo() {
    ...
    // Limpia el resultado después de 4 segundos 
    setTimeout(() => {
        resultado.innerHTML = ""; 
    }, 4000);
}

    // Agrega un evento de escuchar las teclas y cuando se presiona Enter se ejecuta el boton 
